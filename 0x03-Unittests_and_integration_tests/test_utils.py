#!/usr/bin/env python3
"""
Will test for access nested map function
"""
...
class TestAccessNestedMap(unittest.TestCase):
    """
    WIll test the access nested map function
    """
    ...
    def test_access_nested_map(self, nested_map: Mapping,
        ...
        """
        Will test the access nested map method.
        Args:
    ...
    def test_access_nested_map_exception(self, nested_map: Mapping,
                                         path: Sequence) -> None:
        """
        Will test the access nested map method raises an error when expected to
        Args:
            nested_map (Dict): A dictionary that may have nested dictionaries
            path (List, tuple, set): Keys to get to the required value in the
                                     nested dictionary
...
class TestGetJson(unittest.TestCase):
    """
    Will test the get_json function
    """
    @parameterized.expand([
...
class TestMemoize(unittest.TestCase):
    """
    Will test the memoization decorator, memoize
    """
    def test_memoize(self):
        """
        Will test that utils.memoize decorator works as intended
        """
        class TestClass:
